    ...
    <div class='h-screen w-screen bg-gray-100 flex items-center'>
        <div class='container flex flex-col md:flex-row items-center justify-center px-5 text-gray-700'>
            <div class='max-w-md'>
                ...
                <p class="mb-8">Но можно перейти на главную и поискать снова.</p>

                <a href="/<?= Container::get('config')->script_folder ?>" class="px-4 inline py-2 text-sm font-medium
                leading-5 shadow text-white
                transition-colors
                duration-150 border border-transparent rounded-lg focus:outline-none focus:shadow-outline-blue bg-blue-600 active:bg-blue-600 hover:bg-blue-700">
                    на главную
                </a>
            </div>
            <div class="max-w-lg">
...
<?php
require(__DIR__.'./../partials/empty_footer.php');
?>